...
public class MainActivity extends AppCompatActivity {
    ...
    public void sim (View View){
        Toast.makeText(this, "Desenhos são muito divertidos", Toast.LENGTH_SHORT).show();
    }
    ...
    public void site (View View){
        String url = "http://www.cartoonnetwork.com.br/";
    ...
    public void youtube (View View){
        String url = "https://www.youtube.com/user/BRCartoonNetwork";
        Intent i = new Intent(Intent.ACTION_VIEW);
        i.setData(Uri.parse(url));
        startActivity(i);
    }
   ...
   public void sobre (View View) {
       ...
       AlertDialog.setTitle("Cartoon Network");
       AlertDialog.setMessage("Copyright Lucas Inácio");
       AlertDialog.show();
   }
